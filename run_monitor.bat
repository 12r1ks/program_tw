...
```batch:run_monitor.bat
@echo off
echo Starting Twitter Monitor...
if exist "dist\TwitterMonitor.exe" (
    start "" "dist\TwitterMonitor.exe"
) else (
    echo Executable not found. Please run build_monitor.bat first to create it.
    pause
)
```
